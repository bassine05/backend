...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post operations_url, params: { operation: { name: @operation.name, tarification_id: @operation.tarification_id, type: @operation.type } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { name: @operation.name, tarification_id: @operation.tarification_id, type: @operation.type } }
