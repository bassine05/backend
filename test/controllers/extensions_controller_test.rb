...
class ExtensionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post extensions_url, params: { extension: { description: @extension.description, name: @extension.name } }
    end
  ...
  test "should update extension" do
    patch extension_url(@extension), params: { extension: { description: @extension.description, name: @extension.name } }
